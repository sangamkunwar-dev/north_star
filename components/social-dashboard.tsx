...
import { BarChart3, CalendarClock, Check, FileText, ImagePlus, LayoutDashboard, LifeBuoy, LogOut, Menu, PenLine, Plus, Settings2, Sparkles, Trash2, Video, X } from 'lucide-react'
